    ...
    <div>
      ...
      <section className="bg-gradient-to-br from-vccp-dark via-gray-900 to-vccp-charcoal text-white py-20 px-4">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <h1 className="text-4xl md:text-6xl font-bold font-serif text-vccp-gold mt-4 mb-3 tracking-wide">
      ...
      <section className="bg-vccp-charcoal text-white">
        <div className="max-w-7xl mx-auto px-4 py-6 grid grid-cols-2 md:grid-cols-4 gap-4 text-center">
          <div>
            <p className="text-vccp-gold text-2xl font-bold">{listings.length}+</p>
            <p className="text-gray-400 text-sm">Vehicles Listed</p>
          </div>
          <div>
            <p className="text-vccp-gold text-2xl font-bold">{auctions.length}+</p>
            <p className="text-gray-400 text-sm">Auctions Held</p>
          </div>
          <div>
            <p className="text-vccp-gold text-2xl font-bold">75+</p>
            <p className="text-gray-400 text-sm">Years Coverage</p>
          </div>
          <div>
            <p className="text-vccp-gold text-2xl font-bold">18+</p>
        ...
        <section className="max-w-7xl mx-auto px-4 py-12">
          <div className="flex items-center justify-between mb-6">
            <div className="flex items-center gap-2">
              <Gavel className="text-vccp-gold" size={22} />
              <h2 className="text-2xl font-bold font-serif text-vccp-dark">Live Auctions</h2>
              <span className="bg-red-500 text-white text-xs font-bold px-2 py-0.5 rounded-full animate-pulse ml-1">LIVE</span>
            </div>
            <Link to="/auctions" className="text-vccp-gold hover:underline text-sm font-semibold">View All →</Link>
          </div>
      ...
      <section className="bg-white py-12">
        <div className="max-w-7xl mx-auto px-4">
          <div className="flex items-center gap-2 mb-6">
            <Car className="text-vccp-gold" size={22} />
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-6 gap-4">
            {MAKES_FEATURED.map((make) => (
              <Link
                ...
                className="bg-vccp-cream border-2 border-vccp-gold rounded-xl p-4 text-center hover:bg-vccp-gold hover:text-vccp-dark transition-all group"
              >
                <div className="text-3xl mb-1">🚗</div>
                <p className="font-bold text-sm">{make.name}</p>
                <p className="text-xs text-gray-500 group-hover:text-vccp-dark">{make.years}</p>
              </Link>
            ))}
          </div>
        </div>
      ...
      <section className="max-w-7xl mx-auto px-4 py-12">
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center gap-2">
            <Star className="text-vccp-gold" size={22} />
            <h2 className="text-2xl font-bold font-serif text-vccp-dark">Featured Listings</h2>
          </div>
          <Link to="/listings" className="text-vccp-gold hover:underline text-sm font-semibold">View All →</Link>
        </div>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
      ...
      <section className="bg-vccp-dark text-white py-12">
        <div className="max-w-7xl mx-auto px-4">
          <h2 className="text-2xl font-bold font-serif text-vccp-gold text-center mb-8">Why Choose VCCP?</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              <Shield className="text-vccp-gold mx-auto mb-3" size={36} />
            ...
            <div className="text-center">
              <Gavel className="text-vccp-gold mx-auto mb-3" size={36} />
            ...
            <div className="text-center">
              <TrendingUp className="text-vccp-gold mx-auto mb-3" size={36} />
      ...
      <section className="max-w-7xl mx-auto px-4 py-12 text-center">
        <div className="bg-gradient-to-r from-vccp-gold to-yellow-500 rounded-2xl p-10">
          <Clock className="text-vccp-dark mx-auto mb-3" size={40} />
          <h2 className="text-3xl font-bold font-serif text-vccp-dark mb-3">Ready to Sell Your Classic?</h2>
          <p className="text-vccp-dark mb-6 text-base">List your vintage car for sale or run a live auction — it's free to get started.</p>
          <div className="flex gap-4 justify-center flex-wrap">
            <Link to="/sell" className="bg-vccp-dark text-white font-bold px-8 py-3 rounded hover:bg-gray-800 transition-colors">
              List For Sale
            </Link>
            <Link to="/auctions/create" className="bg-white text-vccp-dark font-bold px-8 py-3 rounded hover:bg-gray-100 transition-colors">
              Create Auction
            </Link>
          </div>
        </div>
